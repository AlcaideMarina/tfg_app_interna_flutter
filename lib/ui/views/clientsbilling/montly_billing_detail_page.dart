...
class MonthlyBillingDetailPage extends StatefulWidget {
  const MonthlyBillingDetailPage(this.currentUser, this.billingData, this.isThisMonth, {Key? key}) : super(key: key);
  ...
  @override
  State<MonthlyBillingDetailPage> createState() => _MonthlyBillingDetailPageState();
}
