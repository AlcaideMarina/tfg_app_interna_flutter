...
class InternalUserDetailPage extends StatefulWidget {
  const InternalUserDetailPage(this.currentUser, this.internalUserModel,
      {Key? key})
      : super(key: key);
...
class _InternalUserDetailPageState extends State<InternalUserDetailPage> {
  ...
  deleteUser() async {
    ...
    bool conf = await FirebaseUtils.instance
        .deleteDocument("user_info", internalUserModel.documentId!);
  ...
  navigateToModifyInternalUser() async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                ModifyInternalUserPage(currentUser, internalUserModel)));
