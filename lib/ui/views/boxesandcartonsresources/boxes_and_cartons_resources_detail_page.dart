...
class BoxesAndCartonsResourceDetailPage extends StatefulWidget {
  const BoxesAndCartonsResourceDetailPage(
  ...
  @override
  State<BoxesAndCartonsResourceDetailPage> createState() =>
      _BoxesAndCartonsResourceDetailPageState();
}

class _BoxesAndCartonsResourceDetailPageState
    extends State<BoxesAndCartonsResourceDetailPage> {
  ...
  deleteBCResource() async {
    ...
    bool conf = await FirebaseUtils.instance.deleteDocument(
        "material_boxes_and_cartons", bcResourcesModel.documentId!);
  ...
  navigateToNewHensTicker() async {
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              ModifyBoxesAndCartonsResourcesPage(currentUser, bcResourcesModel),
        ));
